...
namespace System
{
    ...
    {
        glUniform2fv(glGetUniformLocation(ID, name.c_str()), 1, &value.coordinates.x);
    }
    ...
    {
        glUniform3fv(glGetUniformLocation(ID, name.c_str()), 1, &value.coordinates.x);
    }
    ...
    {
        glUniform4fv(glGetUniformLocation(ID, name.c_str()), 1, &value.coordinates.x);
    }
